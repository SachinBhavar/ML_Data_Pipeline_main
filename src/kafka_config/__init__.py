...
SCHEMA_REGISTRY_API_KEY = '2H7LSZZPSGRFYKAY'#os.getenv('SCHEMA_REGISTRY_API_KEY',None)
SCHEMA_REGISTRY_API_SECRET ='LMM41CGgNEk27hHCC6hO1WtAts+wug5XNblB3YTKLSDeai0Th+PAu+r2eFrSWJAW' #os.getenv('SCHEMA_REGISTRY_API_SECRET',None)
